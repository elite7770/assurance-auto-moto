...
const AppointmentBooking = () => {
  ...
  const services = [
    {
      id: 'consultation',
      name: 'Consultation Assurance',
      duration: 30,
      description: 'Discussion sur vos besoins d\'assurance',
      price: 'Gratuit'
    },
    {
      id: 'devis',
      ...
      duration: 45,
      description: 'Étude de votre situation et devis détaillé',
      price: 'Gratuit'
    },
    {
      id: 'sinistre',
      name: 'Accompagnement Sinistre',
      duration: 60,
      description: 'Assistance pour déclaration de sinistre',
      price: 'Gratuit'
    },
    {
      id: 'renouvellement',
      ...
      duration: 30,
      description: 'Optimisation de votre contrat existant',
      price: 'Gratuit'
    }
  ];
  ...
  return (
    <div className="appointment-booking">
      <div className="booking-header">
        ...
        <p>Planifiez une consultation avec nos experts en assurance</p>
      </div>
      ...
      <div className="booking-progress">
        ...
        <div className={`progress-step ${currentStep >= 3 ? 'active' : ''}`}>
          ...
          <span className="step-label">Heure</span>
        </div>
